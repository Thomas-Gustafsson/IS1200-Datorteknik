...
void print_sieves(int input)
{
    ...
    // tilldelar minna åt arrayen eftersom den är dynamisk
    char *numbers = malloc (sizeof (char) * array_size); // malloc tilldelar minne i heap:en
    ...
    free(numbers); // Återtar minnet från arrayen (POP i MIPS assambley)
}
